...
//  (Shopify, WooCommerce, custom Node/Laravel/Django)
// ═══════════════════════════════════════════════════════
...
export const API = {
  ...
  pages: {
    list: () => get<PaginatedResponse<import("./types").ContentPage>>("/pages"),
    get: (id: string) =>
      get<ApiResponse<import("./types").ContentPage>>(`/pages/${id}`),
    create: (data: unknown) =>
      post<ApiResponse<import("./types").ContentPage>>("/pages", data),
    update: (id: string, data: unknown) =>
      patch<ApiResponse<import("./types").ContentPage>>(`/pages/${id}`, data),
    delete: (id: string) => del<ApiResponse<void>>(`/pages/${id}`),
  },

  blog: {
    list: () =>
      get<PaginatedResponse<import("./types").BlogPost>>("/blog/posts"),
    get: (id: string) =>
      get<ApiResponse<import("./types").BlogPost>>(`/blog/posts/${id}`),
    create: (data: unknown) =>
      post<ApiResponse<import("./types").BlogPost>>("/blog/posts", data),
    update: (id: string, data: unknown) =>
      patch<ApiResponse<import("./types").BlogPost>>(`/blog/posts/${id}`, data),
